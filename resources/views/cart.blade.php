                        ...
                        <form class="form-cart">
                            <div class="table-cart">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach(Cart::instance('default')->content() as $cart)
                                        <tr>
                                            <td class="tb-image"><a href="#" class="item-photo"><img src="{{ asset('product/'.$cart->model->image) }}" alt="cart"></a></td>
                                            <td class="tb-product">
                    ...
                    <div class="col-md-3 padding-left-5">
                        <div class="order-summary">
                            ...
                            <div class="checkout-element-content">
                                <span class="order-left">Subtotal:<span>${{ Cart::subtotal() }}</span></span>
                                <span class="order-left">Shipping:<span>Free Shipping</span></span>
                                <span class="order-left">Total:<span>${{ Cart::total() }}</span></span>
                                <ul>
                                    <li><label class="inline" ><input type="checkbox"><span class="input"></span>I have promo code</label></li>
                                </ul>
                                <a href="{{ route('cart.update') }}" type="submit" class="btn-checkout" >
                                    <span>Check Out</span>
                                </a>
                            </div>
                        </div>
