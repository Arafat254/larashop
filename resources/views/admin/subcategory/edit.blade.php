...
Create new subcategory
 ...
 <form role="form" class="form-horizontal form-groups-bordered" method="POST" action="{{ route('admin.subcategory.update',$subcategory->id) }}"> 
 	@method('PUT')
 	@csrf
	<div class="form-group"> 
		<label for="field-1" class="col-sm-3 control-label">Subcategory Name</label> 
			<div class="col-sm-5"> 
				<input type="text" class="form-control" value="{{ $subcategory->name }}" name="name" id="field-1" placeholder="Enter subcategory name"> 
		</div> 
	</div> 
